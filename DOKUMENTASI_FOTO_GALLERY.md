# 📸 DOKUMENTASI FITUR FOTO GALLERY - SI-BORI

## 🎯 Ringkasan Update

Fitur foto gallery telah berhasil ditambahkan ke website SI-BORI! Sekarang admin dapat:
...
3. **database/db_sibori_with_foto.sql** - Database lengkap dengan kolom foto
...
- Drop database lama: `DROP DATABASE db_sibori;`
- Import file: `database/db_sibori_with_foto.sql`
...
│   └── database.php
├── database/
│   ├── db_sibori_with_foto.sql       ← DATABASE BARU
│   ├── update_foto_gallery.sql       ← QUERY UPDATE
│   ├── si-bori.sql                   ← DATABASE LAMA
│   └── sample_penyusun.sql
├── menu/
│   ├── dokumentasi.php
│   ├── etnomatematika.php
...
**Developer:** SI-BORI Development Team  
