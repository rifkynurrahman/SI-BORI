...
$dbname     = "if0_40382552_db_sibori";  // Nama database dari panel
...
// 4. Data Menu
$menu_data = [
    ['identitas', 'Identitas SI-BORI', 'SI-BORI (Smart Innovative Boardgame Geometri) hadir sebagai manifestasi...'],
    ['logo', 'Filosofi Logo SI-BORI', 'Logo SI-BORI dirancang untuk melambangkan...'],
    ['etnomatematika', 'Etnomatematika Jawa Tengah', 'Etnomatematika dalam SI-BORI hadir untuk membuktikan...'],
    ['gladhen', 'Kartu Gladhen', 'To be continued..'],
    ['penyusun', 'Seputar Penyusun', '• Dr. Henry Suryo Bintoro, S. Pd., M. Pd...'],
    ['dokumentasi', 'Dokumentasi SI-BORI', 'Dokumentasi ini merangkum perjalanan kreatif...']
];
