...
<div class="hero-section text-center py-5">
    ...
    <div class="logo-container mb-4">
        <img src="assets/img/LOGO SI-BORI.png" 
             alt="Logo SI-BORI" 
             class="img-fluid" 
...
<div class="container">
    <div class="row">
        ...
        $menu_descriptions = [
            'identitas' => 'Informasi lengkap tentang SI-BORI dan tujuannya dalam pendidikan matematika.',
            'logo' => 'Makna filosofis di balik desain logo SI-BORI yang sarat nilai budaya Jawa.',
            ...
            'dokumentasi' => 'Galeri dokumentasi kegiatan dan perkembangan SI-BORI dari waktu ke waktu.',
