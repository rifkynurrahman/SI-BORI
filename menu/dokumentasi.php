...
if (!$data) {
    $data = [
        'judul' => 'Dokumentasi SI-BORI',
        'konten' => 'Dokumentasi ini merangkum perjalanan kreatif lahirnya SI-BORI.'
    ];
}

$dokumentasi_items = [
    [
        'image' => 'https://via.placeholder.com/400x300/8B4513/ffffff?text=Workshop+SI-BORI',
        'title' => 'Workshop Pengembangan SI-BORI',
        'description' => 'Sesi brainstorming dan workshop intensif dalam pengembangan media pembelajaran SI-BORI'
    ],
    [
        'image' => 'https://via.placeholder.com/400x300/D2691E/ffffff?text=LOGO SI-BORI',
        'title' => 'LOGO SI-BORI',
        'description' => 'Logo resmi SI-BORI yang mencerminkan nilai-nilai etnomatematika'
    ],
    [
        'image' => 'https://via.placeholder.com/400x300/FF6B35/ffffff?text=Presentasi+Media',
        'title' => 'Presentasi Media Pembelajaran',
        'description' => 'Presentasi SI-BORI di forum pendidikan matematika'
    ],
    [
    ...
    [
        ...
        'title' => 'Tim Penyusun SI-BORI',
        'description' => 'Foto bersama tim penyusun setelah menyelesaikan prototype SI-BORI'
    ],
    [
        'image' => 'https://via.placeholder.com/400x300/FF6B35/ffffff?text=Etnomatematika',
        'title' => 'Eksplorasi Etnomatematika',
        'description' => 'Penelusuran objek-objek budaya Jawa Tengah untuk materi SI-BORI'
    ]
];
?>
