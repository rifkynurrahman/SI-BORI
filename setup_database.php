...
$sql = "CREATE DATABASE IF NOT EXISTS db_sibori";
if ($conn->query($sql) === TRUE) {
    echo "Database db_sibori berhasil dibuat atau sudah ada.<br>";
} else {
    echo "Error creating database: " . $conn->error . "<br>";
}

// Pilih database
$conn->select_db("db_sibori");
...
// Buat tabel penyusun jika belum ada
$sql = "CREATE TABLE IF NOT EXISTS penyusun (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
if ($conn->query($sql) === TRUE) {
    echo "Tabel penyusun berhasil dibuat.<br>";
} else {
    echo "Error creating table penyusun: " . $conn->error . "<br>";
}

// Insert admin default jika belum ada
$sql = "INSERT IGNORE INTO admin (username, password) VALUES ('gokil', MD5('gokil123'))";
if ($conn->query($sql) === TRUE) {
...
foreach ($menu_data as $menu) {
    ...
    if ($stmt->execute()) {
        echo "Menu {$menu[0]} berhasil ditambahkan.<br>";
    } else {
        echo "Error inserting menu {$menu[0]}: " . $stmt->error . "<br>";
    }
}
